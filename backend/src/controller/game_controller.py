...
from schema.game_model import GamePlayModel, GameReadModel, GameResponseModel
...
async def get_games(id_player: int, game_mode: str = None, game_service=Depends(get_game_service)):
    """
